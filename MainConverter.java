...
//import swing for inteface creating
...
public class MainConverter {
	...
	public void destination() {
		...
		while (chooser) {
			...
			if (s1 == first.countryNum) {
				System.out.println("Time in " + first.destination + " is Currently: "
						+ (String.format("%02d", country1)) + ":" + (String.format("%02d", mm)));
			} else if (s1 == second.countryNum) {
				System.out.println("Time in " + second.destination + " is Currently: "
						+ (String.format("%02d", country2)) + ":" + (String.format("%02d", mm)));
			} else if (s1 == third.countryNum) {
				System.out.println("Time in " + third.destination + " is Currently: "
						+ (String.format("%02d", country3)) + ":" + (String.format("%02d", mm)));
			} else if (s1 == fourth.countryNum) {
				System.out.println("Time in " + fourth.destination + " is Currently: "
						+ (String.format("%02d", country4)) + ":" + (String.format("%02d", mm)));
			} else if (s1 == fifth.countryNum) {
				System.out.println("Time in " + fifth.destination + " is Currently: "
						+ (String.format("%02d", country5)) + ":" + (String.format("%02d", mm)));
			} else if (s1 == sixth.countryNum) {
				System.out.println("Time in " + sixth.destination + " is Currently: "
						+ (String.format("%02d", country6)) + ":" + (String.format("%02d", mm)));
			} else if (s1 == seventh.countryNum) {
				System.out.println("Time in " + seventh.destination + " is Currently: "
						+ (String.format("%02d", country7)) + ":" + (String.format("%02d", mm)));
			} else {
	...
	public void customConv() {
		...
		for (int i = 1; i < 3; i++) {
			...
			System.out
					.println("Enter Destination " + i + "'s Hour Difference from GMT (use negative value if behind):");
		...
		for (Timezone num : timeList) {
			index = index + 1;
			System.out.println(index + ") " + "Destination: " + num.getDestination() + "  " + "Hour Difference: "
					+ num.getHourDiff());
		}
		System.out.println("");
		...
		for (Timezone num2 : timeList) {
			...
			if (num10 < 0) {
				num10 = num10 + 24;
				System.out.println("Time in " + num2.getDestination() + " is Currently: "
						+ (String.format("%02d", num10)) + ":" + (String.format("%02d", mm)));
			} else if (num11 >= 24) {
				num11 = num11 - 24;
				System.out.println("Time in " + num2.getDestination() + " is Currently: "
						+ (String.format("%02d", num11)) + ":" + (String.format("%02d", mm)));
			} else {
				System.out.println("Time in " + num2.getDestination() + " is Currently: "
						+ (String.format("%02d", num2.getHourDiff() + hh)) + ":" + (String.format("%02d", mm)));
			}
		}
